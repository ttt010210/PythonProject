...
async def parse_cmd():
    ...
    parser.add_argument('--platform', type=str, help='Media platform select ',
    ...
    parser.add_argument('--save_data_option', type=str,
                        help='where to save the data (csv or json)', choices=['csv', 'json'], default=config.SAVE_DATA_OPTION)
